  ...
  return (
    ...
    <section className='footer'>
      ...
      <div className='box-container'>
        ...
        <div className='box'>
          <h3> <i className='fas fa-school'></i> Growing Tree Kindergarten</h3>
          <p>Exploring, Growing, Thriving Together</p>
        </div>
...
{/*
        <div className='box'>
          <h3>quick links</h3>
          <a href='#'> <i className='fas fa-caret-right'></i> enroll now</a>
        ...
        <div className='box'>
          ...
          <a href='#'> <i className='fas fa-caret-right'></i> admission</a>
...
*/}
      ...
      <div className='credit'> &copy; copyright @ 2024 by <span>D. Badibanga</span></div>
    </section>
    </>
  );
};
